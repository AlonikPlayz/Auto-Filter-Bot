...
# Bot information
API_ID = environ.get('API_ID', '22235438')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'd061c8a617c91bbb3bca568d32b8e2eb') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1276438328') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002170026168').split()]
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002153603297') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-4274277446') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://shanm57874:0gq3bYOdkgva6Cu5@cluster0.fofujf2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
UPI_ID = environ.get('UPI_ID', 'shan12@fam') # Add your upi id here
# for stream
IS_STREAM = is_enabled('IS_STREAM', True) #true if you want stream feature active in your bot
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002188825808") #if is_stream = true then add a channel id ex: -10026393639
